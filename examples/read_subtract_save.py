...
if __name__ == "__main__":
    ...
    diff.comment1 = (
        "This is the result of subtraction of two cube files: "
        "`delta_dm.cube` - `delta_dm_pol.cube`."
    )
    diff.comment2 = "Volumetric data should be in agreement with `delta_dm_exch.cube`."
